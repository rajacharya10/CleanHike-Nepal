...
import { Mountain, MapPin, Mail, Phone, Facebook, Twitter, Instagram, Youtube, Heart } from 'lucide-react';

const quickLinks = [
  { name: 'All Hikes', path: '/hikes' },
  { name: 'Featured Treks', path: '/hikes?featured=true' },
  { name: 'Easy Hikes', path: '/hikes?difficulty=easy' },
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3 group">
              <motion.div
                ...
                className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center"
              >
                <Mountain className="w-7 h-7 text-white" />
              </motion.div>
              <div>
                <span className="font-bold text-xl">Clean<span className="text-emerald-400">Hike</span></span>
                <span className="block text-xs text-gray-400">Nepal</span>
              </div>
            </Link>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © {currentYear} CleanHike Nepal. All rights reserved.
            </p>
